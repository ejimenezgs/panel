(() => {
  ...
  function toggleContextMenu(trigger){ const menu=trigger?.closest('.context-menu'); if(!menu)return; const willOpen=!menu.classList.contains('is-open'); closeContextMenus(menu); menu.classList.toggle('is-open',willOpen); trigger.setAttribute('aria-expanded',String(willOpen)); const panel=menu.querySelector('.context-menu__panel'); if(panel)panel.hidden=!willOpen; }
